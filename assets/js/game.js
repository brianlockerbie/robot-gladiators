...
var fightOrSkip = function() {
  ...
  if (promptFight === "skip") {
    ...
    if (confirmSkip) {
      ...
      // stop while() loop using break; nd enter next fight
...
var startGame = function() {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    // if player is not alive, break out of the loop and let endGame functionrun
    else {
...
var endGame = function() {
  ...
  if (playAgainConfirm) {
    ...
    window.alert('Thank you fo playing Robot Gladiators! Come back soon!');
  }
};
...
// ATrt first game when page loads
startGame();
